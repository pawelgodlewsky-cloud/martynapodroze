const CACHE = "lombardia-v21-carto-slow-scooter";
const LOCAL = [
  ...
  "data/tips.json", "data/transport.json", "data/glossary.json", "data/food.json", "data/sources.json", "data/emergency.json", "data/routes.geojson",
