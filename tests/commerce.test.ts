...
describe("commerce security", () => {
  ...
  it("serves Rome preview from its own product root", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith("https://raw.githubusercontent.com/pawelgodlewsky-cloud/martynapodroze/5c581737c2770a626a6798d0ac700f1d8a5072ee/rome/data/guide.json", expect.any(Object));
  });
  ...
  it("serves the public Rome test route without an access token", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith("https://raw.githubusercontent.com/pawelgodlewsky-cloud/martynapodroze/5c581737c2770a626a6798d0ac700f1d8a5072ee/rome/index.html", expect.any(Object));
  });
});
