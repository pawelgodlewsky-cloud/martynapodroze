...
describe("commerce security", () => {
  ...
  it("serves Rome preview from its own product root", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith("https://raw.githubusercontent.com/pawelgodlewsky-cloud/martynapodroze/f02c61e9fd1868775c35891a05fd7f18b1b6ea74/rome/data/guide.json", expect.any(Object));
  });
  ...
  it("serves the public Rome test route without an access token", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith("https://raw.githubusercontent.com/pawelgodlewsky-cloud/martynapodroze/f02c61e9fd1868775c35891a05fd7f18b1b6ea74/rome/index.html", expect.any(Object));
  });
});
