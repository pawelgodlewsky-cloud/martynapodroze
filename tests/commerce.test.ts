...
describe("commerce security", () => {
  ...
  it("serves an unlisted preview only when the path token matches", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith("https://raw.githubusercontent.com/pawelgodlewsky-cloud/martynapodroze/e157ef8e919f7aa1cf9cd3ef00b974488a6b535a/como/styles.css", expect.any(Object));
